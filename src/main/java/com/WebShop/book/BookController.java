...
public class BookController {
    ...
    public void exampleBase () {
        ...
        Book[] books = {
                ...
                new Book(BooksCategory.SCIFI.categoryName, "Diuna", "Arrakis, zwana Diuną, to jedyne we wszechświecie źródło melanżu. Z rozkazu Padyszacha Imperatora planetę przejmują Atrydzi, zaciekli wrogowie władających nią dotychczas Harkonnenów. Zwycięstwo księcia Leto Atrydy jest jednak pozorne – przejęcie planety ukartowano. W odpowiedzi na atak Imperium i Harkonnenów dziedzic rodu Atrydów Paul staje na czele rdzennych mieszkańców Diuny i sięga po imperialny tron. Oszałamiające połączenie przygody i mistycyzmu, ekologii i polityki. „Diuna” otrzymała dwie najbardziej prestiżowe nagrody SF: Nebula i Hugo.", "Herbert Frank", 21, 23.46, "diuna")
        };
